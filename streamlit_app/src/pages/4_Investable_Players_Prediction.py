...
with tab2:
    ...
    code = """curl -X 'POST' \
        'http://20.224.70.229:4100/batch_predict?model_name=nba-investment-model-precision' \
        -H 'accept: application/json' \
        -H 'Content-Type: multipart/form-data' \
        -F 'file=@nba_logreg_raw.csv;type=text/csv' """
        
    st.code(code)
    st.write("The above code is the curl command to make a prediction")
    st.write("Important: The model_name parameter is the name of the model you want to use for prediction, you can choose between nba-investment-model-precision, nba-investment-model-recall, nba-investment-model-f1")
...
with tab1:
    ...
    code = """
    curl -X 'POST' \
  'http://20.224.70.229:4100/online_predict' \
  -H 'accept: application/json' \
